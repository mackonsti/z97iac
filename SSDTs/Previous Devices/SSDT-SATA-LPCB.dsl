 ...
 *     - Added compatibility ID to (LPCB) and (SATA) for improved vanilla detection
 *
 *     References:
...
DefinitionBlock ("SSDT-SATA-LPCB.aml", "SSDT", 1, "Clover", "DevInj", 0x00000000)
{
    Method (\_SB.PCI0.LPCB._DSM, 4, NotSerialized)  // Intel Corporation 9 Series Chipset Family Z97 LPC Controller [8086:8cc4]
    {
        ...
        Return (Package (0x06)
        {
            ...
            "compatible", Buffer (0x0D) {"pci8086,8c44"},  // Intel 8 Series Chipset Family Z87 LPC Controller [8086:8c44]
        //  "IOName",     Buffer (0x0D) {"pci8086,8c44"},
        //  "name",       Buffer (0x0D) {"pci8086,8c44"},
            "model",      Buffer (0x3D) {"Intel Corporation 9 Series Chipset Family Z97 LPC Controller"}
        })
    }
    ...
    Method (\_SB.PCI0.SATA._DSM, 4, NotSerialized)  // Intel Corporation 9 Series Chipset Family SATA Controller [AHCI Mode] [8086:8c82]
    {
        ...
        Return (Package (0x06)
        {
            ...
            "compatible", Buffer (0x0D) {"pci8086,8c02"},  // Intel 8 Series Chipset Family SATA Controller [8086:8c02]
        //  "IOName",     Buffer (0x0D) {"pci8086,8c02"},
        //  "name",       Buffer (0x0D) {"pci8086,8c02"},
