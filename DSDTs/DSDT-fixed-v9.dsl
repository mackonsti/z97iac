 ...
 *     Version 9: Removed Device (RP06) (RP07) (RP08)
 */
...
//  Removed External (RP06)
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (((Arg0 == 0x03) || (Arg0 == 0x04)))
        {
            ...
            // Removed Section (RP6D) for (RP06)

            // Removed Section (RP7D) for (RP07)

            // Removed Section (RP8D) for (RP08)
        }
