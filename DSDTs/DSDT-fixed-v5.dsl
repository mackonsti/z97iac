...
//              }
            ...
            Device (RP03)  // Intel Corporation 9 Series Chipset Family PCI Express Root Port 3 [8086:8c94]
            {
                ...
                Device (PXSX)  // Realtek Semiconductor RTL8111G PCI Express Gigabit Ethernet Controller [10ec:8168]
                {
                    Name (_ADR, Zero)  // _ADR: Address
                    Method (_PRW, 0, NotSerialized)  // _PRW: Power Resources for Wake
                    {
            ...
            Device (RP05)  // Intel Corporation 9 Series Chipset Family PCI Express Root Port 5 [8086:8c98]
            {
                ...
                Device (PXSX)  // Broadcom Corporation BCM4352 802.11ac Wireless Network Adapter [14e4:43b1]
                {
                    Name (_ADR, Zero)  // _ADR: Address
                    Method (_PRW, 0, NotSerialized)  // _PRW: Power Resources for Wake
                    {
