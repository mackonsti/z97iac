 ...
 *
 * Disassembly of DSDT.aml, Fri Oct 24 13:59:02 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006D62 (28002)
 *     Revision         0x03
 *     Checksum         0x0B
 *     OEM ID           "APPLE "
 *     OEM Table ID     "iMac"
...
DefinitionBlock ("DSDT.aml", "DSDT", 3, "APPLE ", "iMac", 0x00150001)
{
    /*
    ...
    External (_SB_.PCI0.UTLK, MethodObj)    // 2 Arguments
    ...
    OperationRegion (GNVS, SystemMemory, 0x8CD3AA90, 0x026D)
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (EC)
                {
                    ...
                    Method (_Q80, 0, NotSerialized)  // _Qxx: EC Query
                    {
                        ...
                        Else
                        {
                            Notify (\_SB.PCI0.P0P2.GFX0, 0x81)
                        }
                    }
            ...
            Scope (\_SB.PCI0.RP03)
            {
                ...
                Method (WAPS, 0, Serialized)
                {
                    ...
                    Store (0x0142106B, \_SB.PCI0.RP03.ARPT.BDDR)
            ...
            Scope (\_SB.PCI0.RP01)
            {
                ...
                Method (TSSD, 0, Serialized)
                {
                    ...
                    While (LLessEqual (Timer, Local0))
                    {
                        If (LAnd (LEqual (LACT, 0x01), LNotEqual (\_SB.PCI0.RP01.SSD0.SVID, 0xFFFF)))
                        {
                            Store (0x00, Local1)
    ...
    Field (RSTR, DWordAcc, Lock, Preserve)
    {
        CIOR,   32,
        Offset (0xF0),
        ICME,   32
